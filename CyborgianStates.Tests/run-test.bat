...
coverlet bin\Debug\net7.0\CyborgianStates.Tests.dll --target "dotnet" --targetargs "test --no-build" --exclude "[*]CyborgianStates.Wrapper.*" --exclude "[*]CyborgianStates.Data.*" --exclude "[*]CyborgianStates.AppSettings" --exclude "[NationStatesSharp]*" --format opencover --output "./TestResults//"
pause
